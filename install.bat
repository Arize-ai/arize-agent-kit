...
REM claude->claude-code-tracing  codex->codex-tracing  copilot->copilot-tracing  cursor->cursor-tracing
...
:resolve_dir
set "HARNESS_DIR="
if /i "%~1"=="claude"      set "HARNESS_DIR=claude-code-tracing"
if /i "%~1"=="claude-code" set "HARNESS_DIR=claude-code-tracing"
if /i "%~1"=="codex"       set "HARNESS_DIR=codex-tracing"
if /i "%~1"=="copilot"     set "HARNESS_DIR=copilot-tracing"
if /i "%~1"=="cursor"      set "HARNESS_DIR=cursor-tracing"
