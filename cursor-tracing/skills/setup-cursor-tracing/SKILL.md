...
Cursor uses a `.cursor/hooks.json` file in the project root to route hook events to the handler. The handler is the `arize-hook-cursor` CLI command installed with the package.
