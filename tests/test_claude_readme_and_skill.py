...
class TestClaudeReadmeMarketplace:
    ...
    def test_marketplace_add_command(self):
        assert "claude plugin marketplace add Arize-ai/coding-harness-tracing" in self.text

    def test_plugin_install_command(self):
        assert "claude plugin install claude-code-tracing@coding-harness-tracing" in self.text

    def test_plugin_uninstall_command(self):
        assert "claude plugin uninstall claude-code-tracing@coding-harness-tracing" in self.text

    def test_marketplace_remove_command(self):
        assert "claude plugin marketplace remove Arize-ai/coding-harness-tracing" in self.text
